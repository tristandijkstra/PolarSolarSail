...
class Properties:
    def __init__(self):
        ...
        self.area_total = (2 * self.area_facing_sun) + (
    ...
    def passive_thermal_mass(self, layers):
        self.passive_thermal_mass = self.insulation() + self.heat_shield(
            layers
        )  # mass of passive thermal elements
